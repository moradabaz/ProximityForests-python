...
python3 ../application/PFApplication.py $CUR_DIR -name=$1 -train=$DATASET_DIR/$1_TRAIN.arff -test=$DATASET_DIR/$1_TEST.arff -repeat=1 -trees=100 -candidates=5 -targetlast=True -calculate=accuracy
